...
//   const { user, updateUser, changePassword, updatePreferences, uploadAvatar } = useAuth();
...
//                       <span className="text-white text-3xl font-semibold">{user.initials}</span>
//                     </div>
//                   )}
//                   <label className={`
...
//                   </label>
//                 </div>
//                 <h3 className={`mt-3 font-medium ${darkMode ? 'text-white' : 'text-gray-900'}`}>
//                   {user.username}
//                 </h3>
...
//                         {user.security.loginHistory.map((entry, index) => (
//                           <div
//                             key={index}
//                             className={`
